...
const books: Book[] = [
  ...
  },
  {
    ...
    category: 'PSIKOLOJIK',
    coverImageUrl:
      'https://i.dr.com.tr/cache/500x400-0/originals/0000000064552-1.jpg',
  ...
  },
  {
    ...
    category: 'TARIH',
    coverImageUrl:
      'https://cdn1.dokuzsoft.com/u/ilknokta/img/b/v/e/vedaae87dd4fbc903c8576524e9094095446.jpg',
  ...
  },
  {
    ...
    category: 'TARIH',
    coverImageUrl:
      'https://www.ilknokta.com/u/ilknokta/img/b/p/u/puslu-kitalar-atlasieb0986e981f3e03875094c42a0261e5e.jpg',
  ...
  },
  {
    ...
    category: 'TARIH',
    coverImageUrl:
      'https://cdn1.dokuzsoft.com/u/ilknokta/img/b/e/f/efsane1503170d70b343f4da323815b322598d.jpg',
  ...
  },
  {
    ...
    category: 'KLASIKLER',
    coverImageUrl:
      'https://www.ilknokta.com/u/ilknokta/img/b/d/u/duello-1677745612.jpg',
  ...
  },
  {
    ...
    category: 'POLISIYE',
    coverImageUrl:
      'https://www.ilknokta.com/u/ilknokta/img/b/9/7/9786254497667-1679990566.jpg',
  ...
  },
  {
    ...
    coverImageUrl:
      'https://www.ilknokta.com/u/ilknokta/img/b/g/u/gunesin-altin-elmalari-1677151814.jpg',
  ...
  },
  {
    ...
    category: 'BILIM KURGU',
    coverImageUrl:
      'https://www.ilknokta.com/u/ilknokta/img/b/9/7/9786258327939-dusyilani-vonda-n-mcintyre-1666265843.jpg',
  ...
  },
  {
    ...
    category: 'FANTASTIK',
    coverImageUrl:
      'https://www.ilknokta.com/u/ilknokta/img/b/9/7/9786053048053-1677500897.jpg',
  ...
  },
  {
    ...
    category: 'FANTASTIK',
    coverImageUrl:
      'https://www.ilknokta.com/u/ilknokta/img/b/9/7/9786053047568-1664179046.jpg',
  ...
  },
  {
    ...
    category: 'POLISIYE',
    coverImageUrl:
      'https://cdn1.dokuzsoft.com/u/ilknokta/img/b/b/e/beyoglunun-en-guzel-abisibd0c062b45bdf795f5496d1a6182f84e.jpg',
    ...
    routes() {
      ...
      this.get(
        ...
        (schema: any, request: any) => {
          const books = schema.db.books.filter(
            (book: Book) => book.category === request.params.category
          );
          return books;
        }
      );
